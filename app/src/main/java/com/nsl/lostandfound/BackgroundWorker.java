/**
*\brief This is the BackGround Worker file.This Code will be invoked when User clicks the report button in mislayer activity .
*This class is recieving data from report activity and sending it to the php file.
...
/**\class class with name BackgroundWorker is being created here.BackgroundWorker extends AsyncTask.
*/
        ...
        if(type.equals("login")) {
            try {
                ...
                String post_data = URLEncoder.encode("name","UTF-8")+"="+URLEncoder.encode(name,"UTF-8")+"&"+
                        ...
                        URLEncoder.encode("Status","UTF-8")+"="+URLEncoder.encode("l","UTF-8");
